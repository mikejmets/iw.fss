...
$Id: FileSystemStorage.py 48845 2007-09-07 09:35:30Z zegor $
"""
__author__  = ''
...
class VirtualBinary(VirtualData):
    ...
    def index_html(self, REQUEST, RESPONSE=None):
        ...
        RESPONSE.setHeader('Accept-Ranges','none')  # Disable range mode because filestream_iterator can't manage it
